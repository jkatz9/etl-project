...
-- Exported by jukatz at 11-03-2025 11:22.
-- WARNING: This file may contain descructive statements such as DROPs.
-- Please ensure that you are running the script at the proper location.


-- BEGIN TABLE public.campaign
...
-- Inserting 1000 rows into public.campaign
-- Insert batch #1
INSERT INTO public.campaign ("Cf_id", "Contact_id", "Company_name", "Description", "Goal", "Pledged", "Outcome", "Backers_count", "Country", "Currency", "Launch_date", "End_date", "Category_id", "Subcategory_id") VALUES
...
-- END TABLE public.campaign

-- BEGIN TABLE public.category
...
-- Inserting 9 rows into public.category
-- Insert batch #1
...
-- END TABLE public.category

-- BEGIN TABLE public.contacts
...
-- Inserting 1000 rows into public.contacts
-- Insert batch #1
INSERT INTO public.contacts ("Contact_id", "First_name", "Last_name", email) VALUES
...
-- END TABLE public.contacts

-- BEGIN TABLE public.subcategory
...
-- Inserting 24 rows into public.subcategory
-- Insert batch #1
INSERT INTO public.subcategory ("Subcategory_id", "Subcategory_name") VALUES
('subcat1', 'food trucks'),
('subcat2', 'rock'),
('subcat3', 'web'),
('subcat4', 'plays'),
...
-- END TABLE public.subcategory

ALTER TABLE IF EXISTS public.campaign
	ADD CONSTRAINT "campaign_Category_id_fkey"
	FOREIGN KEY ("Category_id")
	REFERENCES public.category ("Category_id");

ALTER TABLE IF EXISTS public.campaign
	ADD CONSTRAINT "campaign_Contact_id_fkey"
	FOREIGN KEY ("Contact_id")
	REFERENCES public.contacts ("Contact_id");

ALTER TABLE IF EXISTS public.campaign
	ADD CONSTRAINT "campaign_Subcategory_id_fkey"
	FOREIGN KEY ("Subcategory_id")
	REFERENCES public.subcategory ("Subcategory_id");
